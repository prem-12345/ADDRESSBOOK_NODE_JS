...
class AddressBook {
    ...
    const addressBook1 = new AddressBook("Prem","Patil","Nashik","Nashik","Maharashtra","422101","+91 7387557696","prem@gmail.com");
    contactArray.push(addressBook1); 

    const addressBook2 = new AddressBook("Kalpesh","Patil","Mumbai","Mumbai","Maharashtra","422104","+91 7387557686","kal@gmail.com");
    contactArray.push(addressBook2); 

    const addressBook3 = new AddressBook("Vedant","Patil","Mumbai","Mumbai","Maharashtra","422104","+91 7387597686","ved@gmail.com");
    ...
    const addressbook4 = new AddressBook("Prem","Patil","Nashik","Nashik","Maharashtra","422101","+91 7387557696","prem@gmail.com");
    if (!contactArray.some(el => el.firstname == "Prem"))
    ...
    let checkCity = contactArray.filter((e) => e.city == 'Nashik');
